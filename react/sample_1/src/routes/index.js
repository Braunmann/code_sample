...
export default {
  ...
  children: [
    ...
    require('./viewListing').viewListingWithSlug,
    ...
    require('./siteadmin/addcms').default,
    require('./siteadmin/editcms').default,
    require('./siteadmin/cms').default,
    require('./siteadmin/editblock').default,
    require('./siteadmin/blocks').default,
