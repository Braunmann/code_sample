...
class PaymentDetails extends Component {
  ...
  render() {
    ...
    const { totalWithoutFees } = this.props;
          ...
          <Col xs={12} sm={12} md={12} lg={12} className={s.smPadding}>
            <table className={cx('table')}>
              <tbody>
                ...
                {
                  serviceFees > 0 && <tr>
                    <td className={cx(s.noBorder, s.discountText)}>
                      <FormattedMessage {...messages.paidLable} />
                    </td>
                    <td className={cx(s.noBorder, s.discountText, 'text-right')}>
                      <span>
                        <CurrencyConverter
                          amount={serviceFees}
                          from={currency}
                ...
                {
                  totalWithoutFees > 0 && <tr>
                    <td className={cx(s.noBorder, s.paidLater)}>
                      <FormattedMessage {...messages.payForLater} />
                    </td>
                    <td className={cx(s.noBorder, s.paidLater, 'text-right')}>
                      <span>
                        <CurrencyConverter
